 ...
 * VideoAttachment
 */
public class VideoAttachment extends Attachment implements MaxSerializable {

    @NotNull
    private final @Valid MediaAttachmentPayload payload;
    @Nullable
    private @Valid VideoThumbnail thumbnail;
    @Nullable
    ...
    **/
    ...
    public VideoAttachment thumbnail(@Nullable VideoThumbnail thumbnail) {
    ...
    **/
    ...
    public void setThumbnail(@Nullable VideoThumbnail thumbnail) {
