...
import ru.max.botapi.queries.AnswerOnCallbackQuery;
...
import ru.max.botapi.queries.DeleteAdminsQuery;
import ru.max.botapi.queries.DeleteChatQuery;
import ru.max.botapi.queries.DeleteMessageQuery;
import ru.max.botapi.queries.EditChatQuery;
import ru.max.botapi.queries.EditMessageQuery;
import ru.max.botapi.queries.EditMyInfoQuery;
import ru.max.botapi.queries.GetAdminsQuery;
import ru.max.botapi.queries.GetChatByLinkQuery;
import ru.max.botapi.queries.GetChatQuery;
import ru.max.botapi.queries.GetChatsQuery;
import ru.max.botapi.queries.GetMembersQuery;
import ru.max.botapi.queries.GetMembershipQuery;
import ru.max.botapi.queries.GetMessageByIdQuery;
import ru.max.botapi.queries.GetMessagesQuery;
import ru.max.botapi.queries.GetMyInfoQuery;
import ru.max.botapi.queries.GetPinnedMessageQuery;
...
import ru.max.botapi.queries.GetUploadUrlQuery;
import ru.max.botapi.queries.GetVideoAttachmentDetailsQuery;
import ru.max.botapi.queries.LeaveChatQuery;
import ru.max.botapi.model.Message;
import ru.max.botapi.model.MessageList;
import ru.max.botapi.model.NewMessageBody;
import ru.max.botapi.model.PinMessageBody;
import ru.max.botapi.queries.PinMessageQuery;
import ru.max.botapi.queries.PostAdminsQuery;
import ru.max.botapi.queries.RemoveMemberQuery;
import ru.max.botapi.queries.SendActionQuery;
...
import ru.max.botapi.queries.UnpinMessageQuery;
