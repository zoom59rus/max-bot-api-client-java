...
public class DeleteAdminsQuery extends MaxQuery<SimpleQueryResult> {
    public static final String PATH_TEMPLATE = "/chats/{chatId}/members/admins/{userId}";

    public DeleteAdminsQuery(MaxClient client, Long chatId, Long userId) {
        super(client, substitute(PATH_TEMPLATE, chatId, userId), null, SimpleQueryResult.class, Method.DELETE);
    }
}
