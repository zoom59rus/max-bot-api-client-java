...
public class ModelTest {
    ...
    public void testAllModels() throws Throwable {
        for (Class aClass : getClasses("ru.max.botapi.model")) {
    ...
    private void testEnum(Class<? extends Enum<?>> anEnum) {
        ...
        for (Enum<?> enumConstant : enumConstants) {
            if (enumConstant instanceof MaxEnum) {
                assertThat(MaxEnum.create(enumConstant.getDeclaringClass(), ((MaxEnum) enumConstant).getValue()), is(enumConstant));
            }
        }
    }
